...
Rect DetectCascade(CascadeClassifier &cascade, Mat &image, int minNeighbours)
{
	...
	cascade.detectMultiScale(image, faces, 2.0, 3, CV_HAAR_SCALE_IMAGE, Size(64, 64)); //change made 1.5 to 2.0
...
int RunPulse()
{
	String old_video = "C:/Users/sasi.smart/Documents/0_UT Dallas/2nd Sem/VA/Project/Test Video.avi";
	String name = "C:/Users/sasi.smart/Documents/0_UT Dallas/2nd Sem/VA/Project/HeartRate1.avi";
	VideoCapture pulseCam(name);
	...
	Rect face;
	int threshFace = 5;//change from 5 to 7
